...
# Time is a flat circle !?
    ...
    So i'd gave it a shot.At first, i should note that my favorite type of shows are ones leave me little bit puzzled and messed up in the head huh ! Hopefully in a good way
    and there is very few of them that actually do dig that deep into showing me some asepects of myself that i might be oblivious to and when it do 
    i'm always amazed by the depth of the show and the way it's written .Not only that i try to keep posters of them as a reminder to remind myself of the lessons i learned from them .
