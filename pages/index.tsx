  ...
  return (
    <>
      ...
      <div>
        ...
        <h1 className='text-xl font-extrabold text-red-400 rotate-12 md:text-2xl'>
        Software Engineer
        </h1>
        <h1  className='text-xl font-extrabold text-yellow-400 rotate-12 md:text-2xl'>
          Guitarist
        </h1>
        <h1  className='text-xl font-extrabold text-blue-500 rotate-12 md:text-2xl'>
         Athlete
        </h1>
        </div>
        </div>
        ...
        <div className="pb-8 space-y-2 md:space-y-5">
          <h1 className="text-2xl leading-9 tracking-tight text-center text-gray-900 mono-type dark:text-gray-100 sm:text-4xl sm:leading-10 md:text-xl md:leading-14">
        ...
        <div className="flex flex-col items-start justify-start md:justify-center md:items-center md:flex-row md:space-x-6 md:mt-24">
          ...
          <h2 className='mt-2 font-bold text-gray-400 text-md md:text-2xl'>
